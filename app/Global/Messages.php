...
class Messages
{
    public const DELETE_CONFIRMATION_MESSAGE = 'Tem certeza que deseja excluir o registro ?';
    public const CREATE_MESSAGE = 'Registro criado com sucesso!';
    public const UPDATE_MESSAGE = 'Registro atualizado com sucesso!';
