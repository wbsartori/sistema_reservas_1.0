<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" maxlength="50" id="quilometragem_atual"
        ...
        <div class="form-group">
            ...
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" id="status"
                       name="status" <?= isset($registers->status) && $registers->status === \App\Enums\StatusEnum::ATIVO->value ? 'checked' : ''; ?>>
                <label class="form-check-label"
                       for="status"><?= isset($registers->status) && $registers->status === \App\Enums\StatusEnum::ATIVO->value ? 'Inativar' : 'Ativar'; ?></label>
            </div>
        </div>
    </div>
</div>
