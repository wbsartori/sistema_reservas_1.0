...
$Utils = new Utils();
$reserva = $Utils->listarReservasSalas($_SESSION['users']['usuario_autenticacao']['id']);
?>
...
<hr class="bg-dark">
<?php if($_SESSION['users']['reservar_sala']['cadastra'] === 'S') { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="btn-group float-end" role="group" aria-label="Basic example">
                                ...
                                <?php if($_SESSION['users']['reservar_sala']['usuario_aprovador'] === 'S' && $_SESSION['users']['usuario_autenticacao']['id'] == $item['reserva_id_usuario']) { ?>
                                ...
                                <?php if($_SESSION['users']['reservar_sala']['altera'] === 'S' && $_SESSION['users']['usuario_autenticacao']['id'] == $item['reserva_id_usuario']) { ?>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <hr>
                                                <label for="sala_descricao">Reserva:</label>
                                                <input type="text" class="form-control" id="sala_descricao" name="sala_descricao" value="<?php echo $item['sala_descricao'];?>" disabled>
                                                <hr>
                                                ...
                                                <input type="text" class="form-control" id="hora_inicio" name="hora_inicio" value="<?php echo  $item['horario_descricao'];?>" disabled>
                                                <hr>
                                            </div>
                                            <div class="modal-footer">
