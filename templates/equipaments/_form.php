<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="id_equipamento_tipo">Tipo de equipamento</label>
                    <input type="text" class="form-control" id="descricao" name="descricao" maxlength="100"
                           value="<?= $equipamento['descricao'] ?? ''; ?>">
                </div>
                <div class="form-group">
                    <label for="id_equipamento_marca">Marca de Equipamento</label>
                    <input type="text" class="form-control" id="descricao" name="descricao" maxlength="100"
                           value="<?= $equipamento['descricao'] ?? ''; ?>">
                </div>
                <div class="form-group">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="prazo_garantia_fabricante" name="prazo_garantia_fabricante"
                   ...
                   value="<?= $equipamento['prazo_garantia_fabricante'] ?? ''; ?>">
        </div>
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="prazo_garantia_loja" name="prazo_garantia_loja"
                   maxlength="100" placeholder="Quantidade de Meses"
                   value="<?= $equipamento['prazo_garantia_loja'] ?? ''; ?>">
        </div>
    </div>
</div>
<hr>
<div class="row">
    <div class="col-md-3">
        ...
        <div class="form-check form-switch">
            <?php if (isset($equipamento['status']) && $equipamento['status'] == 'A') { ?>
        ...
        <div class="form-group">
            ...
            <div class="form-floating">
                <textarea class="form-control" id="observacoes" name="observacoes" placeholder="Leave a comment here"
                          style="height: 100px"><?= $equipamento['observacoes'] ?? ''; ?></textarea>
