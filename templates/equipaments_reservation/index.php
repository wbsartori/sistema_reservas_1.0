...
$Utils = new Utils();
$reserva = $Utils->listarReservasEquipamentos($_SESSION['users']['usuario_autenticacao']['id']);
...
<hr class="bg-dark">
<?php if($_SESSION['users']['reservar_equipamento']['cadastra'] === 'S') { ?>
    <a href="new.php" class="btn btn-primary">Reservar</a>
    <hr class="bg-dark">
<?php } ?>
...
<div class="container-fluid">
    <div class="row mt-5">
        <table class="table table-striped">
            ...
            <tr>
                <th scope="col">Id</th>
                <th scope="col">Equipamento reservado</th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="btn-group float-end" role="group" aria-label="Basic example">
                                ...
                                <?php if($_SESSION['users']['reservar_equipamento']['usuario_aprovador'] === 'S' && $_SESSION['users']['usuario_autenticacao']['id'] == $item['reserva_id_usuario']) { ?>
                                ...
                                <?php if($_SESSION['users']['reservar_equipamento']['altera'] === 'S' && $_SESSION['users']['usuario_autenticacao']['id'] == $item['reserva_id_usuario']) { ?>
                                ...
                                <?php if($_SESSION['users']['reservar_equipamento']['deleta'] === 'S' && $_SESSION['users']['usuario_autenticacao']['id'] == $item['reserva_id_usuario']) { ?>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <hr>
                                                <label for="equipamento_descricao">Reserva:</label>
                                                <input type="text" class="form-control" id="equipamento_descricao" name="equipamento_descricao" value="<?php echo $item['equipamento_descricao'];?>" disabled>
                                                <hr>
