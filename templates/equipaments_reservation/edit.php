...
use App\Classes\Reserva\Services\ReservaService;
...
$reserva = $ReservaService->editarReservasEquipamentos($_SESSION['users']['usuario_autenticacao']['id']);
...
<div class="container">
    <h4 class="mt-5">Editar Reserva de Equipamento</h4>
    <hr class="bg-dark">
    <div class="row mt-5">
        <div class="col-md-12">
